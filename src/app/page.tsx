      ...
      <div className="w-full max-w-md bg-white border border-gray-200 rounded-3xl p-6 sm:p-8 shadow-xl">
        ...
        <div className="flex gap-2 mb-8">
          ...
          <input 
            ...
            className="flex-1 bg-gray-100 border border-gray-200 rounded-xl px-4 py-3 text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:bg-white outline-none transition-all"
          />
          ...
          <button 
            ...
            disabled={loading}
            className="bg-blue-600 hover:bg-blue-700 active:scale-95 px-6 py-3 rounded-xl font-semibold text-white transition-all disabled:opacity-50"
          >
            {loading ? "..." : "Go"}
          </button>
